...
export default async function handler(req, res) {
  ...
  const state = String(req.query.state || ""); // pairing code
  ...
  // result: { user, accessToken, refreshToken, idToken, ... }
  ...
  await saveSession(state, {
    ...
    result: {
      ...
      // OPTIONAL: add firebaseCustomToken here if you decide to mint one
    },
  });
